    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-muted/30">
      <Card className="w-full max-w-lg text-center">
        <CardContent className="pt-10 pb-8 px-8 space-y-6">
          ...
          <div>
            <h1 className="font-heading text-2xl font-bold mb-2">Booking Confirmed! 🎉</h1>
          ...
          <div className="bg-muted rounded-lg p-5 text-left space-y-3">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium">{format(new Date(data.checkIn), "MMM dd, yyyy")}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground flex items-center gap-1">
                <CalendarDays className="h-3.5 w-3.5" /> Check-out
              </span>
              <span className="font-medium">{format(new Date(data.checkOut), "MMM dd, yyyy")}</span>
            </div>
